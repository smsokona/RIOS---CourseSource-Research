...
#coloring groups (color blind safe colors) based on the shift (2014-2018 and 2019-2022)
  ...
  boxplot(`Word Count of Inclusive Teaching?`~ Year,
          ...
          horizontal = TRUE, 
          col = c("#005AB5", "#005AB5", "#005AB5", "#005AB5", "#DC3220","#DC3220", "#DC3220", "#DC3220", "#DC3220"))
...
#          data = rios_data,
#          subset = `Group Year` %in% c("2014 - 2018", "2019 - 2022"))
# 
# test #p-value = 1.557e-10, confidence interval:  -126.37537  -68.78427, df = 254?!
# 
# riosdata_before18 <- rios_data %>% 
#   filter(`Group Year` == "2014 - 2018")
# 
# riosdata_after18 <- rios_data %>% 
#   filter(`Group Year` == "2019 - 2022")
# 
# test_before18 <- t.test(x = riosdata_before18$`Word Count of Inclusive Teaching?`)
# test_after18 <- t.test(x = riosdata_after18$`Word Count of Inclusive Teaching?`)
# 
# test_before18 #p-value < 2.2e-16, confidence interval:  102.6193 134.3544, df = 75...
# test_after18 #p-value < 2.2e-16, confidence interval: 191.8702 240.2632, df = 179...
...
rios_data_tokenizedit %>%
  ...
  with(wordcloud(inclusive_tokens_stem, log_n))
...
## In Depth Bar Chart of _Stemmed_ Word Count By Year {.tabset}

### 2014

```{r  stem2014, warning=FALSE}
