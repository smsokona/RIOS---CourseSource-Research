---
title: "RIOS Research - Inclusive Teaching Data Analysis"
...
```{r top 15 common dei words, dev='png'}
...
Below is a bar chart that looks more in depth into the frequency of words being used, each year. As mentioned above, the word *students* is an outlier, so I use the log of the word counts. We can see the diversity of words increases, beginning in 2019. I also create a line graph, which highlights the words that are used more frequently after 2018. This is consistent with the visualizations above.
