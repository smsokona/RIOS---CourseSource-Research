...
```{r barplot and line graph of wrd ct over time, dev='png'}
...
Below you can see the bar chart above more clearly. Click on each tab to see the word frequency for each year.
