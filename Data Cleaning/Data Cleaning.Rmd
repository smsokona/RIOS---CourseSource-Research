...
rios_data <- read_csv("C:/Users/smangane/OneDrive - bates.edu/RIOS Research/RIOS---CourseSource-Research/Data Cleaning/Data for Import/RIOS Research - Course Source - Sheet1 2.csv")
...
dei_keywords <- read_csv("C:/Users/smangane/OneDrive - bates.edu/RIOS Research/RIOS---CourseSource-Research/Data Cleaning/Data for Import/SJEDI_words 2022-12-20 18_03_42.csv")
...
JEDI_keywords_df <- read_csv("C:/Users/smangane/OneDrive - bates.edu/RIOS Research/RIOS---CourseSource-Research/Data Cleaning/Data for Import/cleanedITwords - cleanedITwords.csv") %>% 
  filter(Carrie == "JEDI") %>% 
  select(1)
...
JEDI_2keywords_df <- read_csv("C:/Users/smangane/OneDrive - bates.edu/RIOS Research/RIOS---CourseSource-Research/Data Cleaning/Data for Import/cleanedIT2words.csv") %>% 
  filter(...3 == "JEDI") %>% 
  select(1)
...
# original dataframe
write_csv(rios_data, "C:/Users/smangane/OneDrive - bates.edu/RIOS Research/RIOS---CourseSource-Research/Data Cleaning/Data for Export/rios_data.csv") #CHANGE FOLDER PATH ON COMPUTER
