...
rios_data <- read_csv("/cloud/project/Data Cleaning/Data for Import/RIOS Research - Course Source - Sheet1 2.csv")
...
dei_keywords <- read_csv("/cloud/project/Data Cleaning/Data for Import/SJEDI_words 2022-12-20 18_03_42.csv")
...
ASK YUHAO FOR DESPCRIPTIONS OF THESE CODE CHUNKS...
...
JEDI_keywords_df <- read_csv("/cloud/project/Data Cleaning/Data for Import/cleanedITwords - cleanedITwords.csv") %>% 
  filter(Carrie == "JEDI") %>% 
  select(1)
...
JEDI_2keywords_df <- read_csv("/cloud/project/Data Cleaning/Data for Import/cleanedIT2words.csv") %>% 
  filter(...3 == "JEDI") %>% 
  select(1)
...
```{r export cleaned df's}

# original dataframe
write_csv(rios_data, "/cloud/project/Data Cleaning/Data for Export/rios_data.csv") #CHANGE FOLDER PATH ON COMPUTER

# tokenized dataframe
write_csv(rios_data_tokenizedit, "/cloud/project/Data Cleaning/Data for Export/rios_data_tokenized.csv")

# tokenized dataframe for 2word phrases
write_csv(rios_data_token2it, "/cloud/project/Data Cleaning/Data for Export/rios_data_tokenized2.csv")

# tokenized dataframe for 3word phrases
write_csv(rios_data_token3it, "/cloud/project/Data Cleaning/Data for Export/rios_data_tokenized3.csv")

# table of DEI related word counts by year
write_csv(it_word_counts, "/cloud/project/Data Cleaning/Data for Export/dei_word_counts.csv")


# lists of JEDI keywords, just in case
write_csv(JEDI_keywords_df, "/cloud/project/Data Cleaning/Data for Export/JEDIkeywords.csv")
write_csv(JEDI_2keywords_df, "/cloud/project/Data Cleaning/Data for Export/JEDI2keywords.csv")
